...
The Multiple Interface Visual studio demo showcases the Multiple Interfaces
functionality of the FreeRTOS+TCP IPv6/multi-interface library. It shows that
the library will use different endpoints (IP-addresses) to connect to IP-addresses
