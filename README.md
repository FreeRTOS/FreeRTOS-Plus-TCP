...
## Note
At this time it is recommended to leave ipconfigBUFFER_ALLOC_FIXED_SIZE disabled in which case it is essential to use the heap_4.c memory allocation scheme. See [memory management](http://www.FreeRTOS.org/a00111.html).
