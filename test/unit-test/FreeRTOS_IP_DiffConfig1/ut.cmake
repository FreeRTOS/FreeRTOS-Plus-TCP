...
set(project_name "FreeRTOS_IP_DiffConfig1")
...
list(
  ...
  "${MODULE_ROOT_DIR}/test/unit-test/${project_name}/IP_DiffConfig1_list_macros.h"
)
...
list(APPEND real_source_files ${project_name}/${project_name}_stubs.c
