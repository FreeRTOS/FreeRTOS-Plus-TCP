...
execute_process(COMMAND rm -f ${CMAKE_BINARY_DIR}/coverage.info)
...
if(1)
  ...
  execute_process(
    COMMAND
      lcov --rc lcov_branch_coverage=1 --remove
      ${CMAKE_BINARY_DIR}/coverage.info *FreeRTOS-Kernel* --output-file
  ...
  execute_process(
    COMMAND
      lcov --rc lcov_branch_coverage=1 --remove
      ${CMAKE_BINARY_DIR}/coverage.info *portable* --output-file
      ${CMAKE_BINARY_DIR}/coverage.info)
  ...
  execute_process(
    COMMAND
      lcov --rc lcov_branch_coverage=1 --remove
      ${CMAKE_BINARY_DIR}/coverage.info *stubs* --output-file
      ${CMAKE_BINARY_DIR}/coverage.info)
endif()
