...
function(create_test test_name test_src link_list dep_list include_list)
  ...
  add_custom_command(
    ...
    COMMAND
      ...
      ${MODULE_ROOT_DIR}/test/unit-test/cmock/project.yml ${test_src_absolute}
      ${test_name}_runner.c
    DEPENDS ${test_src})
  add_executable(${test_name} ${test_src} ${test_name}_runner.c)
  set_target_properties(
    ${test_name}
    PROPERTIES COMPILE_FLAG "-Wall -O0 -ggdb"
...
function(create_real_library target src_file real_include_list mock_name)
  ...
  set_target_properties(
    ${target}
    PROPERTIES COMPILE_FLAGS "-O0 -ggdb -Wextra -Wpedantic \
