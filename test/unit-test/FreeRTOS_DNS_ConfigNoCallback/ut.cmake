...
set(project_name "FreeRTOS_DNS_ConfigNoCallback")
...
list(APPEND mock_define_list -DipconfigUSE_DNS=1)
...
list(APPEND real_source_files ${MODULE_ROOT_DIR}/source/FreeRTOS_DNS.c)
