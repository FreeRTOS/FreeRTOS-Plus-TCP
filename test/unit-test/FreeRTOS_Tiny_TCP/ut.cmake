...
set(project_name "FreeRTOS_Tiny_TCP")
message(STATUS "${project_name}")
# =====================  Create your mock here  (edit)  ========================

set(mock_list "")
# list the files to mock here
list(APPEND mock_list "${MODULE_ROOT_DIR}/test/FreeRTOS-Kernel/include/task.h"
     "${CMAKE_BINARY_DIR}/Annexed_TCP/FreeRTOS_IP.h")
# list the directories your mocks need
set(mock_include_list "")
list(APPEND mock_include_list . ${TCP_INCLUDE_DIRS}
...
list(APPEND real_source_files ${project_name}/FreeRTOS_Tiny_TCP_stubs.c
...
target_include_directories(
  ${real_name} PUBLIC ${MODULE_ROOT_DIR}/test/unit-test/${project_name})

target_include_directories(
  ${mock_name} PUBLIC ${MODULE_ROOT_DIR}/test/unit-test/${project_name})

target_include_directories(
  ${utest_name} PUBLIC ${MODULE_ROOT_DIR}/test/unit-test/${project_name})
