...
#define xTaskDelayUntil_ReturnArrayThruPtr_pxPreviousWakeTime(pxPreviousWakeTime, cmock_len) xTaskDelayUntil_CMockReturnMemThruPtr_pxPreviousWakeTime(__LINE__, pxPreviousWakeTime, (int)(cmock_len * (int)sizeof(*pxPreviousWakeTime)))
...
#define vApplicationStackOverflowHook_ReturnArrayThruPtr_pcTaskName(pcTaskName, cmock_len) vApplicationStackOverflowHook_CMockReturnMemThruPtr_pcTaskName(__LINE__, pcTaskName, (int)(cmock_len * (int)sizeof(*pcTaskName)))
...
#define vApplicationGetIdleTaskMemory_ReturnArrayThruPtr_ppxIdleTaskTCBBuffer(ppxIdleTaskTCBBuffer, cmock_len) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_ppxIdleTaskTCBBuffer(__LINE__, ppxIdleTaskTCBBuffer, (int)(cmock_len * (int)sizeof(*ppxIdleTaskTCBBuffer)))
...
#define vApplicationGetIdleTaskMemory_ReturnArrayThruPtr_ppxIdleTaskStackBuffer(ppxIdleTaskStackBuffer, cmock_len) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_ppxIdleTaskStackBuffer(__LINE__, ppxIdleTaskStackBuffer, (int)(cmock_len * (int)sizeof(*ppxIdleTaskStackBuffer)))
...
#define vApplicationGetIdleTaskMemory_ReturnArrayThruPtr_pulIdleTaskStackSize(pulIdleTaskStackSize, cmock_len) vApplicationGetIdleTaskMemory_CMockReturnMemThruPtr_pulIdleTaskStackSize(__LINE__, pulIdleTaskStackSize, (int)(cmock_len * (int)sizeof(*pulIdleTaskStackSize)))
...
typedef UBaseType_t (* CMOCK_uxTaskGetSystemState_CALLBACK)(TaskStatus_t* const pxTaskStatusArray, const UBaseType_t uxArraySize, configRUN_TIME_COUNTER_TYPE* const pulTotalRunTime, int cmock_num_calls);
...
typedef configRUN_TIME_COUNTER_TYPE (* CMOCK_ulTaskGetIdleRunTimeCounter_CALLBACK)(int cmock_num_calls);
...
#define ulTaskGetIdleRunTimePercent_IgnoreAndReturn(cmock_retval) ulTaskGetIdleRunTimePercent_CMockIgnoreAndReturn(__LINE__, cmock_retval)
...
#define ulTaskGetIdleRunTimePercent_StopIgnore() ulTaskGetIdleRunTimePercent_CMockStopIgnore()
...
typedef configRUN_TIME_COUNTER_TYPE (* CMOCK_ulTaskGetIdleRunTimePercent_CALLBACK)(int cmock_num_calls);
...
#define ulTaskGetIdleRunTimePercent_StubWithCallback ulTaskGetIdleRunTimePercent_Stub
...
#define xTaskGenericNotifyWait_ReturnArrayThruPtr_pulNotificationValue(pulNotificationValue, cmock_len) xTaskGenericNotifyWait_CMockReturnMemThruPtr_pulNotificationValue(__LINE__, pulNotificationValue, (int)(cmock_len * (int)sizeof(*pulNotificationValue)))
...
#define vTaskGenericNotifyGiveFromISR_ReturnArrayThruPtr_pxHigherPriorityTaskWoken(pxHigherPriorityTaskWoken, cmock_len) vTaskGenericNotifyGiveFromISR_CMockReturnMemThruPtr_pxHigherPriorityTaskWoken(__LINE__, pxHigherPriorityTaskWoken, (int)(cmock_len * (int)sizeof(*pxHigherPriorityTaskWoken)))
