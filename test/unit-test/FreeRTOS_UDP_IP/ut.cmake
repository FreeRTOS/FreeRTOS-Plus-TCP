...
list(
  ...
  "${MODULE_ROOT_DIR}/test/unit-test/FreeRTOS_UDP_IP/FreeRTOS_UDP_IP_list_macros.h"
)
...
# set(real_include_directories "") list the directories the module under test
# includes
list(
  APPEND
...
# set(test_include_directories "") list the directories your test needs to
# include
list(APPEND test_include_directories . ${CMOCK_DIR}/vendor/unity/src
     ${TCP_INCLUDE_DIRS} ${MODULE_ROOT_DIR}/test/unit-test/${project_name})
