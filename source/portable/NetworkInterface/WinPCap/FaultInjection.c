...
static NetworkBufferDescriptor_t * xNetworkBufferCache[ xBUFFER_CACHE_SIZE ] = {
    0
};
...
static NetworkBufferDescriptor_t * prvDuplicatePacket(
    NetworkBufferDescriptor_t * pxOriginalPacket,
    const uint8_t * pucPacketData )
{
    NetworkBufferDescriptor_t * pxReturn;

    /* Obtain a new descriptor. */
    pxReturn = pxGetNetworkBufferWithDescriptor( pxOriginalPacket->xDataLength,
                                                 0 );
...
static NetworkBufferDescriptor_t * prvRxFaultInjection(
    NetworkBufferDescriptor_t * pxNetworkBufferIn,
    const uint8_t * pucPacketData )
{
    ...
    if( ulCallCount > ulNextFaultCallCount )
    {
        ...
        switch( ulFault )
        {
            ...
            case 4:
                ...
                pxReturn = prvDuplicatePacket( pxNetworkBufferIn,
                                               pucPacketData );
