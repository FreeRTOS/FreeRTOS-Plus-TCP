...
void wakeupHTTPClient( size_t uxIndex, const char *pcHost, const char *pcFileName, BaseType_t xIPType );

/*
 * Create the TCP (HTTP) echo client tasks.
 */
void vStartHTTPClientTest( uint16_t usTaskStackSize, UBaseType_t uxTaskPriority );
